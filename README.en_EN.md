...
### 🚀 FAS (Fast Aggressive Setup) — a highly aggressive script for quickly preparing a fresh Debian/Ubuntu VPS for use. 
...
### 😎 Solution
**FAS** doesn’t wait. It “kicks the door in”: stops background update services, waits for locks to be released, and if necessary kills stuck processes. Then it restores the dpkg state, fixes dependencies, and updates the system in non-interactive mode.
